...
export function BridgeArcs() {
  return (
    <svg viewBox="0 0 640 440" preserveAspectRatio="xMidYMid slice" style={{ width: '100%', height: '100%', display: 'block', animation: 'arcBreathe 6s ease-in-out infinite' }} aria-hidden>
      <g fill="none" stroke="#5CE838" strokeLinecap="round" style={{ animation: 'arcSway 9s ease-in-out infinite, arcShimmer 5s ease-in-out infinite', transformBox: 'fill-box', transformOrigin: 'center' }}>
      ...
      <g stroke="rgba(92,232,56,.35)" strokeWidth="2" strokeLinecap="round">
