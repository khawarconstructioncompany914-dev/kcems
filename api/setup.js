...
export default async function handler(req, res) {
  ...
  const FILES = ['0001_init.sql', '0002_functions.sql', '0003_photos_and_claims.sql', '0004_progress_role_attendance.sql', '0005_ratelimit_idempotency_audit.sql', '0006_attendance_leave_ranges.sql', '0007_view_and_function_hardening.sql', '0008_vendor_bank.sql']
  let sources
  try {
